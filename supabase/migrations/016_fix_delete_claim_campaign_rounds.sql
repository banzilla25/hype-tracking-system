-- ============================================================
-- HYPE Tracking System — Migration 016
-- Fix delete_claim: campaign_rounds.claim_id FK ke claims belum
-- dibersihkan sebelum DELETE FROM claims. Kalau klaim pernah lewat
-- status repeat_campaign (ada baris archive di campaign_rounds),
-- DELETE FROM claims akan gagal kena foreign key violation.
--
...
BEGIN
  ...
  -- 5. Putus FK poi → claim sebelum hapus claim
